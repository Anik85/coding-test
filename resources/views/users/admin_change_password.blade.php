    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            @php 
                ...
                @endphp
            <div class="d-flex flex-column align-items-center text-center"><img src="{{(!empty($adminData->photo)) ? url('upload/user_images/'.$adminData->photo):url('upload/no_image.jpg') }}" alt="User Photo" class="img-fluid rounded-circle mb-2"  />
            <div class="mt-3">
            <h4></h4>
